...
id object_graftImplementationOfProtocolFromClass(id object, Protocol * protocol, Class sourceClass) {
    ...
    auto requests = objcgraft::_ObjCGraftCenter::shared().makeGraftRequests(&unsafe_unretained_protocol, &sourceClass, 1);
    objcgraft::_ObjCGraftCenter::shared().lock();
    id retVal = objcgraft::_ObjCGraftCenter::shared().graftImplementationOfProtocolsFromClassesToObject(object, * requests);
...
id object_graftImplementationsOfProtocolsFromClasses(id object, Protocol __unsafe_unretained * _Nonnull *  _Nonnull protocols, __unsafe_unretained Class _Nonnull * _Nonnull sourceClasses, unsigned int count) {
    auto requests = objcgraft::_ObjCGraftCenter::shared().makeGraftRequests(protocols, sourceClasses, count);
    objcgraft::_ObjCGraftCenter::shared().lock();
    id retVal = objcgraft::_ObjCGraftCenter::shared().graftImplementationOfProtocolsFromClassesToObject(object, * requests);
    objcgraft::_ObjCGraftCenter::shared().unlock();
    return retVal;
...
id object_graftImplementationsOfProtocolsFromClasses_nilTerminated(id object, Protocol * firstProtocol, Class firstSourceClass, ...) {
    ...
    auto requests = objcgraft::_ObjCGraftCenter::shared().makeGraftRequests(protocol_array, source_classes_array, count);
...
id object_graftImplementationsOfProtocolsFromClass(id object, Protocol __unsafe_unretained * _Nonnull *  _Nonnull protocols, unsigned int count, __unsafe_unretained Class _Nonnull sourceClass) {
    auto requests = objcgraft::_ObjCGraftCenter::shared().makeGraftRequests(protocols, count, sourceClass);
    objcgraft::_ObjCGraftCenter::shared().lock();
    id retVal = objcgraft::_ObjCGraftCenter::shared().graftImplementationOfProtocolsFromClassesToObject(object, * requests);
    objcgraft::_ObjCGraftCenter::shared().unlock();
    return retVal;
...
id object_graftImplementationsOfProtocolsFromClass_nilTerminated(id object, __unsafe_unretained Class _Nonnull sourceClass, Protocol * firstProtocol, ...) {
    ...
    auto requests = objcgraft::_ObjCGraftCenter::shared().makeGraftRequests(protocol_array, count, sourceClass);
...
id object_removeGraftedImplementationOfProtocol(id object, Protocol * protocol) {
    Protocol * __unsafe_unretained unsafe_unretained_protocol = protocol;
    objcgraft::_ObjCGraftCenter::shared().lock();
    id retVal = objcgraft::_ObjCGraftCenter::shared().removeGraftedImplementationsOfProtocolsFromObject(object, &unsafe_unretained_protocol, 1);
    objcgraft::_ObjCGraftCenter::shared().unlock();
    return retVal;
}
...
id object_removeGraftedImplementationsOfProtocols(id object, Protocol * __unsafe_unretained _Nonnull *  _Nonnull protocols, unsigned int count) {
    objcgraft::_ObjCGraftCenter::shared().lock();
    id retVal = objcgraft::_ObjCGraftCenter::shared().removeGraftedImplementationsOfProtocolsFromObject(object, protocols, count);
    objcgraft::_ObjCGraftCenter::shared().unlock();
    return retVal;
}
...
id object_removeGraftedImplementationsOfProtocols_nilTerminated(id object, Protocol * firstProtocol, ...) {
    ...
    objcgraft::_ObjCGraftCenter::shared().lock();
    id retVal = objcgraft::_ObjCGraftCenter::shared().removeGraftedImplementationsOfProtocolsFromObject(object, protocol_array, count);
    objcgraft::_ObjCGraftCenter::shared().unlock();
    return retVal;
}
...
id object_removeAllGraftedImplementations(id object) {
    objcgraft::_ObjCGraftCenter::shared().lock();
    id retVal = objcgraft::_ObjCGraftCenter::shared().removeGraftedImplementationsFromObject(object);
    objcgraft::_ObjCGraftCenter::shared().unlock();
    return retVal;
}
...
NSString * object_graftInfoDescription(id object) {
    ...
    objcgraft::_ObjCGraftCenter::shared().lock();
    if (objcgraft::_ObjCGraftCenter::shared().objectHasGraftInfo(object)) {
        NSString * graftInfoDescription = objcgraft::_ObjCGraftCenter::shared().objectGetGraftInfo(object).description();
