...
namespace objcgraft {
    _ObjCGraftResolver& _ObjCGraftResolver::shared() {
        static _ObjCGraftResolver shared_instance;
        return shared_instance;
    }
    
#pragma mark Resolving Composited Class
    std::unique_ptr<_ObjCGraftCombinationList> _ObjCGraftResolver::resolveGraftCombinationList(_ObjCGraftRecordMap &graft_record_map) {
    ...
    NSString * _ObjCGraftResolver::makeGraftRecordIdentifier(_ObjCGraftRecordMap& graft_record_map) {
    ...
    void _ObjCGraftResolver::_resolveProtocolsHierarchy(_ObjCGraftRecordMap& graft_record_map) {
...
#pragma mark Accessing Elements in Registered Protocol Graph
    _ObjCProtocolHierarchyGraph& _ObjCGraftResolver::_protocolHierarchyGraph() {
        return *protocol_hierarchy_graph_;
    }
    
    bool _ObjCGraftResolver::_hasSetHierarchyForProtocol(Protocol * __unsafe_unretained protocol) {
    ...
    _ObjCProtocolList& _ObjCGraftResolver::_hierarchyForProtocol(Protocol * __unsafe_unretained protocol) {
        auto position = protocol_hierarchy_graph_ -> find(protocol);
        return * position -> second;
    }
    
    void _ObjCGraftResolver::_setHierarchyForProtocol(Protocol * __unsafe_unretained protocol, std::unique_ptr<_ObjCProtocolList> protocol_list) {
