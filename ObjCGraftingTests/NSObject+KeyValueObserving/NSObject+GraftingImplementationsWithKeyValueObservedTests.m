//
//  NSObject_GraftingImplementationsWithKeyValueObservedTests.m
//  ObjCGrafting
//
//  Created on 1/1/2019.
//
...
static NSString * _kNSObjectDerivedDummyModelObservationContext = @"com.WeZZard.ObjCGrafting.NSObject_GraftingImplementationsWithKeyValueObservedTests.NSObjectDerivedDummyModelObservationContext";

@interface NSObject_GraftingImplementationsWithKeyValueObservedTests : XCTestCase
@property (nonatomic, strong) NSObjectDerivedDummyModel * object;
@property (nonatomic, assign) BOOL isNameAccessed;
@end

@implementation NSObject_GraftingImplementationsWithKeyValueObservedTests
- (void)setUp
{
